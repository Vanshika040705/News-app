...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.project.newsapp.utils.glidessl.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.project.newsapp.utils.glidessl.GlideOptions().apply(toSet));
    }
  }
}
